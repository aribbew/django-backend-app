...
schema_view = get_schema_view(
   openapi.Info(
      title="langosta - ApiDoc",
      default_version='v1',
      description="Documentacion de la Api Langosta",
      terms_of_service="https://www.google.com/policies/terms/",
      contact=openapi.Contact(email="ariangelbritoserious@gmail.com"),
      license=openapi.License(name="Ariangel Brito"),
   ),
   public=True,
