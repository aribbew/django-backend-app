"""
Django settings for langosta project.
...
SECRET_KEY = 'django-insecure-97lc18u)1jl4h$bmq$5k%%uz^=ntv+)**4l^z3junu)1d48@2n'
...
WSGI_APPLICATION = 'langosta.wsgi.application'
